class StageThree extends eui.Component implements eui.UIComponent {
	public Bg: eui.Rect;
	public Area: string;
	...
	private SetQandOptions(data) {
		...
		this.Question.source = "resource/assets/boundary/"+pictureName+"/512.png";
